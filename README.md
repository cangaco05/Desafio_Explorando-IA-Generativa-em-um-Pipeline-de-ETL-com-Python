...
/ ├── etl.py # Código principal do ETL ├── usuarios_atualizados.json ├── usuarios_atualizados.csv └── README.md #
...
Após rodar, os arquivos JSON e CSV serão gerados automaticamente.
...
- Logging detalhado  
- Dados estruturados no padrão esperado da API antiga  
- Output limpo e fácil de analisar  

---

## 📊 Exemplo de Saída Resumida

👤 João Silva Saldo: R$ 1500.00 Mensagem: João, investir hoje garante um futuro financeiro mais seguro.

👤 Maria Santos Saldo: R$ 3200.00 Mensagem: Maria, faça seu dinheiro trabalhar por você. Invista agora.

👤 Pedro Costa Saldo: R$ 890.00 Mensagem: Pedro, comece a investir e construa seu amanhã financeiro.


---

## 🎯 Objetivo do Projeto
Demonstrar compreensão completa do fluxo **ETL** aplicado a um caso real de marketing bancário, utilizando IA generativa para personalização em escala.
...
## 📝 Licença
Livre para estudo, modificação e uso acadêmico.
